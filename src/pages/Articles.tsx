...
const articles = [
  {
    ...
    wordCount: 2500,
    reads: 0,
    excerpt: "A comprehensive guide to understanding cardiovascular health and modern treatment approaches...",
  ...
  },
  {
    ...
    wordCount: 1800,
    reads: 1247,
    excerpt: "Exploring the impact of technology on mental health and coping strategies for the modern world...",
  ...
  },
  {
    ...
    wordCount: 3200,
    reads: 0,
    excerpt: "Latest breakthroughs in cancer research and innovative treatment methodologies...",
  ...
  },
  {
    ...
    wordCount: 2100,
    reads: 2340,
    excerpt: "How proper nutrition can boost your immune system and protect against diseases...",
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Review, edit, and publish medical articles</p>
        </div>
